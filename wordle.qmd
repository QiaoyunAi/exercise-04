...
title: "wordle.qmd"
format: html
authors: Qiaoyun Ai & Clarissa Aguilar
---
...
play_wordle <- function(solution, valid_list, num_guesses = 6) {
  ...
  # ensure guess exit in dictionary  
  while (!(guess %in% valid_list)) {
      guess <- readline(paste0("Word not in dictionary. Enter guess ", i, " again: ")) |>
        toupper()
    }
    
    guess_vector <- str_split(guess, "")[[1]] # convert guess string to vector
...
evaluate_guess <- function(guess, solution) {
  ...
  # count occurrences of letters in guess
  ...
  # identify letters that appear more times in guess than solution
